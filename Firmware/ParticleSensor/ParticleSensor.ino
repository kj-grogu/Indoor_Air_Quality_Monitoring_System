...
//const char* serverUrl = "34.217.96.154";
...
void loop() {
  if (readPMSdata(&Serial1)) {
    ...
    String SensorData = " Particles > 1.0um/0.1L air-"+ (String)data.particles_10um +";Particles > 2.5um/0.1L air-"+ (String)data.particles_25um + ";Particles > 10.0um/0.1L air-" + (String)data.particles_100um + "";
